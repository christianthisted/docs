...
| [`create_purchase`](/api-reference/create-purchase) | Record a purchase against a lead |
| [`create_purchase_custom`](/api-reference/create-purchase-custom) | Record a purchase with a custom product name |
